...
//   const curActivity = useAppSelector((s) => s.state.activity);
//   const curExperiment = useAppSelector((s) => s.state.experiment);
//   const kernelStatus = useAppSelector((s) => s.notebook.kernelStatus);

//   const curNotebook = useAppSelector((s) => s.notebook.current);
...
//     } finally {
//       setIsRunning(false);
//       setRunCount((prevValue) => prevValue + 1);
//       return notebook;
//     }
//   }
...
//     isEdited,
//     isSaving,
//     notebookIsRunning: isRunning,
//     notebookRunCount: runCount,
//     notebookInitialRunComplete: runCount > 0,
//     saveNotebook,
//     runNotebook,
//     editCode,
//     resetCode,
