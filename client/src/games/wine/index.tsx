  ...
  improveCodeHints: [
    {
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsFitOnTexts;
      },
    },
    {
      message:
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsTextsToSequences;
      },
    },
    {
      message:
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsPadSequences;
      },
    },
    {
      message:
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsPadSequencesWithPaddingPost;
      },
    },
    {
      message:
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsPadSequencesTwice;
      },
    },
    {
      message:
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsReshape;
      },
    },

    {
      ...
      visibility: "TRIGGERED_OR_HINT_BUTTON",
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsReshapeOnXAndY;
      },
    },
    {
      message:
      ...
      visibility: "TRIGGERED_OR_HINT_BUTTON",
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).callsArgmax;
      },
    },
    {
      message:
    ...
    },
    {
      ...
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).hasValidationOutput;
      },
    },
    {
      message:
      ...
      visibility: "TRIGGERED_OR_HINT_BUTTON",
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).dataIsNumpyArray;
      },
    },
    {
      message:
      ...
      visibility: "TRIGGERED_OR_HINT_BUTTON",
      active: (nmtCodeInfo) => {
        return !(nmtCodeInfo as WineCodeInfo).preprocessedDataCorrectDimensions;
      },
    },
    {
      message:
      ...
      visibility: "TRIGGERED_OR_HINT_BUTTON",
      active: (nmtCodeInfo) => {
        return (nmtCodeInfo as WineCodeInfo).keywordZeroLookup;
      },
    },
    {
      message:
      ...
      visibility: "TRIGGERED_OR_HINT_BUTTON",
      active: (nmtCodeInfo) => {
        return (nmtCodeInfo as WineCodeInfo).callsJoin;
      },
    },
    {
